...
We can observe from the plot that the peak of the highest number of fire incidents happen from November to March. However, we spot the total number of incident decrease somewhat from December to February and it suddenly surging in March. We assume that the temperature is extremely low in February, and the fire is less likely to happen.  
...
<img src="./unnamed-chunk-4-1.png" style="width:75%" >
