...
##cannot load get_map
##https://stackoverflow.com/questions/19827598/error-in-get-map-using-ggmap-in-r to creat project
library(ggmap)
map = get_map(location = c(40, -73),zoom = 10, maptype = 'roadmap')

##http://www.kevjohnson.org/making-maps-in-r/
##it does not seem to have zip code data...?

##NEW package to try
library(USAboundariesData)
library(USAboundaries)
us_zipcode = us_zipcodes()

##readShapeSpatial is deprecated
library(maptools)

##
library(tigris)
options(tigris_use_cache = FALSE)
tigris_cache_dir("./data")
readRenviron('~/.Renviron')
zctas(start_with = c("11", "10"))
```
